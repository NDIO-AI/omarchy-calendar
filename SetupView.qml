...
Rectangle {
    ...
    property string accessChoice: "read"
    ...
    signal authenticateRequested(string provider, string access)
        ...
        Column {
            ...
            Row {
                ...
                Text {
                    ...
                    text: "CONNECT " + root.providerName.toUpperCase()
            ...
            Text {
                ...
                textFormat: Text.PlainText
                width: parent.width
                text: root.providerState.client_configured ? root.providerState.registration_source === "bundled" ? "Flight Deck's bundled registration is ready. Choose an access level, then connect in the browser." : "Your local registration is ready. Choose an access level, then connect in the browser." : root.provider === "google" ? "This build has no bundled Google registration. Contributors can import a Google Desktop credentials JSON file as an advanced override." : "This build has no bundled Microsoft registration. Contributors can enter a personal-account capable public application ID as an advanced override."
            ...
            Row {
                ...
                Repeater {
                    ...
                    Rectangle {
                        ...
                        radius: Style.space(6)
                        color: root.accessChoice === modelData.key ? Qt.rgba(0.478, 0.635, 0.969, 0.18) : "transparent"
                        border.color: root.accessChoice === modelData.key ? root.palette.accent : root.palette.border
                        Text {
                            textFormat: Text.PlainText
                            anchors.centerIn: parent
                            text: modelData.label
                            color: root.accessChoice === modelData.key ? root.palette.accent : root.palette.foreground
                            font.family: root.fontFamily
                            font.pixelSize: Style.font.bodySmall * root.textScale
                            font.bold: root.accessChoice === modelData.key
                        }
                        MouseArea {
                            anchors.fill: parent
                            onClicked: root.accessChoice = modelData.key
                        }
                    }
                }
            }
            ...
            Rectangle {
                width: parent.width
                height: Style.space(root.accessChoice === "edit" ? 154 : 132)
                ...
                Column {
                    ...
                    Text {
                        textFormat: Text.PlainText
                        text: "WHAT FLIGHT DECK REQUESTS"
                    ...
                    Text {
                        textFormat: Text.PlainText
                        width: parent.width
                        text: root.provider === "microsoft" ? "Identity and profile so the account can be labeled\nCalendars.Read for events and calendar lists" + (root.accessChoice === "edit" ? "\nCalendars.ReadWrite for changes you save" : "") + "\nOffline access for automatic local refresh" : "Identity and email so the account can be labeled\nCalendar events read-only\nCalendar list read-only" + (root.accessChoice === "edit" ? "\nOwned calendar events for changes you save" : "") + "\nOffline access for automatic local refresh"
                        color: root.palette.foreground
                        font.family: root.fontFamily
                        font.pixelSize: Style.font.bodySmall * root.textScale
                        lineHeight: 1.35
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            visible: clientInput.text === ""
                            text: root.clientPlaceholder
                            color: root.palette.muted
                            font.family: root.fontFamily
                            font.pixelSize: Style.font.caption * root.textScale
                            elide: Text.ElideRight
            ...
            Text {
                ...
                textFormat: Text.PlainText
                width: parent.width
                text: root.provider === "google" ? root.providerState.registration_source === "bundled" ? "The bundled public Desktop app registration ships with Flight Deck. OAuth tokens stay in the system keyring. Calendar data stays in a private local SQLite cache. No hosted backend." : "Your imported Desktop app credential and tokens stay in the system keyring. Only the public client ID is saved in local settings. Calendar data stays in a private local SQLite cache. No hosted backend." : root.providerState.registration_source === "bundled" ? "The bundled public application ID ships with Flight Deck. Tokens stay in the system keyring. Calendar data stays in a private local SQLite cache. No hosted backend." : "Tokens stay in the system keyring. Your public application ID stays in local settings. Calendar data stays in a private local SQLite cache. No hosted backend."
                color: root.palette.muted
                font.family: root.fontFamily
                font.pixelSize: Style.font.caption * root.textScale
                wrapMode: Text.Wrap
