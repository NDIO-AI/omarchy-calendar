...
Item {
    ...
    function revealSelectedEvent() {
        ...
        agenda.contentY = CalendarModel.revealOffset(agenda.contentY, agenda.height, itemY, rowHeight, agenda.contentHeight, Style.space(16));
    }
            ...
            Flickable {
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        Rectangle {
                            ...
                            color: root.selectedUid === String(modelData.uid || "") ? Qt.rgba(0.478, 0.635, 0.969, 0.20) : root.palette.surface || "#1f2335"
                            border.color: root.selectedUid === String(modelData.uid || "") ? root.palette.accent : root.palette.border
                            border.width: 1
                            Behavior on color {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        y: agenda.contentHeight <= agenda.height ? 0 : (parent.height - height) * agenda.contentY / (agenda.contentHeight - agenda.height)
                        radius: width / 2
